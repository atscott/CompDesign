...
public class GPSCoordinate {
	 ...
	 * 
	 * @param longitude
	 *            polar coordinate representing angle (in degrees) from the
	 *            Prime Meridian
	 * @param latitude
	 *            polar coordinate representing angle (in degrees) above the
	 *            equator
	 * @param elevation
	 *            polar coordinate representing elevation (in feet) above sea
	 *            level
	 */
	...
	/**
	 * The distance (in feet) from the current GPSCoordinate to the reference
	 * GPSCoordinate
	 * 
	 * @param c
	 *            reference GPSCoordinate
	 * @return distance (in feet) between the current GPSCoordinate to the
	 *         reference GPSCoordinate
	 */
	private double getDelta(GPSCoordinate c) {
		double x = RADIUS * Math.cos(theta) * (phi - c.phi);
		double y = RADIUS * (theta - c.theta);
		double z = elevation - c.elevation;
